...
| `rf-plugins` | `npx ruflo@latest plugins list` | List installed plugins |
...
| `bd query "status:open"` | Filter open issues |
...
| Hive-mind | `npx ruflo@latest hive-mind init` | Advanced multi-consensus |
...
mcp__ruflo__browser_fill { target: "@e1", value: "..." }
```
